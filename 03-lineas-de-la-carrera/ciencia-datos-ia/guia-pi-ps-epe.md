# Guía PI / PS / EPE — Línea Ciencia de Datos e IA

[← Volver al índice de alumnos](../../00-arquitectura-documentos/indice-alumnos.md)

## Objetivo

Orientar al estudiante de Ciencia de Datos e IA para desarrollar `PS`, `PI` y `EPE` con foco en datos, modelos y valor analítico.
...
- `PS`: artefacto de curso (análisis de datos, ML, IA aplicada, etc.).
...
- Trazabilidad de datos y decisiones de modelado.
- Métricas claras y reproducibilidad básica.
- Artefactos verificables (notebooks, scripts, resultados).
- Sustentación de valor para el problema.
