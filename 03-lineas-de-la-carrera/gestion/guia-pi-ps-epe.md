# Guía PI / PS / EPE — Línea Gestión

[← Volver al índice de alumnos](../../00-arquitectura-documentos/indice-alumnos.md)

## Objetivo

Orientar al estudiante de Gestión para desarrollar `PS`, `PI` y `EPE` con foco en planificación, control y valor organizacional.
...
- `PS`: trabajo aplicado a un curso (gestión TI, procesos, innovación, etc.).
...
- Artefacto clara de análisis y decisiones.
- Indicadores o criterios de seguimiento definidos.
- Coherencia entre diagnóstico, propuesta y resultados.
- Sustentación basada en datos y artefactos.
