# Guía PI / PS / EPE (Operativa)

[← Volver al índice de alumnos](../00-arquitectura-documentos/indice-alumnos.md)

## Objetivo

Orientar al estudiante sobre qué hacer en cada proceso (`PI`, `PS`, `EPE`) de forma simple y ordenada.
...
## Entregables E1–E5 (versión simple)

- `E1`: problema, contexto, objetivo y alcance.
...
1. Definir problema y alcance (brief).
...
- [Guía PS](proyectos-sello-ps/README.md)
- [Guía PI](proyectos-integradores-pi/README.md)
- [Guía EPE](evaluacion-perfil-egreso-epe/README.md)
- [Checklist de entregables](checklist-entregables-e1-e5.md)
