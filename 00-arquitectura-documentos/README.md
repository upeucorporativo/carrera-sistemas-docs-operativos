# Arquitectura de Documentos (Índice)

Este documento define la arquitectura de documentación de `carrera-sistemas-docs-operativos` y funciona como índice base (`00`).

## Índice general

### 00. Arquitectura documental

- [Índice de arquitectura documental](README.md)
- [Índice único para alumnos](indice-alumnos.md)
...
- `00` se reserva para el índice/arquitectura documental.
- La documentación oficial del programa no se duplica en este repositorio.
- Cada carpeta debe mantener un `README.md` cuando aplique, para navegación rápida.
